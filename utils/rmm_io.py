...
def save_rmm_indices(time, RMM1, RMM2, output_path, method_str="WH04_method:_OLR_&_ERA5"):
    ...
    # fill missing
    RMM1_vals[missing_mask] = 9.99999962E+35
    RMM2_vals[missing_mask] = 9.99999962E+35
    amplitude[missing_mask] = 9.99999962E+35
    ...
    print(f"Saved RMM indices to: {output_path}")

def load_rmm_indices(filepath, start_year=1979, MISSING_VAL=9.99999962e35):
    data = []
